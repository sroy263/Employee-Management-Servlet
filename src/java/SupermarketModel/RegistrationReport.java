...
public class RegistrationReport extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        out.println("<html>\n"
                ...
                + "    </head>\n"
                + "    <body>\n"
                + "    <form action='RegistrationReport' method='post' >"
                + "        <center>\n"
            ...
            throws ServletException, IOException 
    {
      ...
      if(data.size()>0)
      {
        out.println("<font color='red' size='7'>Registration Report</font> <br><br>"
                ...
                + "<tr><td>ID</td> <td>NAME</td> <td>ADDRESS</td> <td>MEMBERSHIP</td> "
                + "    <td>GENDER</td> <td>SALARY</td> <td>USERNAME</td> </tr>");
      }
      for(Customer c : data)
      {
         out.println("<tr><td>"+c.i+"</td> <td>"+c.name+"</td> <td>"+c.address+"</td> <td>"+c.mt+"</td> "
                + "    <td>"+c.gen+"</td> <td>"+c.sal+"</td> <td>"+c.user+"</td> </tr>");
      }
      out.println("</table><br><br> <a href='Menu'> OK </a> ");
      out.close();        
    }
}
